  ...
  <div id="accordionPayment" class="accordion">
    <div class="card">
      <div class="card-body">
        ...
        <p>Endpoint: <code><?php echo e(url('/')); ?>/send-message</code></p>
    ...
    "footer": "Sent via mpwa"
        ...
        <p>URL Request</p>
        <pre class="bg-dark rounded text-white"><code><?php echo e(url('/')); ?>/send-message?api_key=1234567890&amp;sender=62888xxxx&amp;number=62888xxxx&amp;message=Hello World&amp;footer=Sent via mpwa</code></pre>
    ...
    "msgid": "3EB031F83D74BF480052B9"
        ...
        <p>URL Request</p>
        <pre class="bg-dark rounded text-white"><code><?php echo e(url('/')); ?>/send-message?api_key=1234567890&amp;sender=62888xxxx&amp;number=62888xxxx&amp;message=Hello World&amp;msgid=3EB031F83D74BF480052B9</code></pre>
    ...
    "full": 1
        ...
        <p>URL Request</p>
        <pre class="bg-dark rounded text-white"><code><?php echo e(url('/')); ?>/send-message?api_key=1234567890&amp;sender=62888xxxx&amp;number=62888xxxx&amp;message=Hello World&amp;footer=Sent via mpwa&amp;full=1</code></pre>
...
<?php /**PATH /www/wwwroot/public_html/website/wa.bdi.asia/resources/themes/vuexy/views/pages/api-docs/send-message.blade.php ENDPATH**/ ?>