...
(function ($) {
    ...
    $('#add-button').click(function () {
        if (buttonIndex >= maxButtons) {
            notyf.error("<?php echo e(__('Maximal 4 button')); ?>");
            return;
        }
...
<?php /**PATH /www/wwwroot/public_html/website/wa.bdi.asia/resources/themes/vuexy/views/ajax/messages/formbutton.blade.php ENDPATH**/ ?>