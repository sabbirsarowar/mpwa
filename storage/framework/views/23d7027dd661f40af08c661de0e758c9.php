  ...
  <div id="accordionPayment" class="accordion">
    <div class="card">
      <div class="card-body">
        ...
        <p>Endpoint: <code><?php echo e(url('/')); ?>/send-poll</code></p>
...
<pre class="bg-dark rounded text-white"><code>{
    ...
    "option": ["red","blue","yellow"]
        ...
        <p>URL Request</p>
<pre class="bg-dark rounded text-white"><code><?php echo e(url('/')); ?>/send-poll?sender=081222xxxxxx&amp;api_key=123456789&amp;number=201111xxxxxx&amp;name=what color do you like&amp;option=red,blue,yellow&amp;countable=1</code></pre>
...
<pre class="bg-dark rounded text-white"><code>{
    ...
    "msgid": "3EB031F83D74BF480052B9"
        ...
        <p>URL Request</p>
<pre class="bg-dark rounded text-white"><code><?php echo e(url('/')); ?>/send-poll?sender=081222xxxxxx&amp;api_key=123456789&amp;number=201111xxxxxx&amp;name=what color do you like&amp;option=red,blue,yellow&amp;countable=1&amp;msgid=3EB031F83D74BF480052B9</code></pre>
...
<pre class="bg-dark rounded text-white"><code>{
    ...
    "full": 1
        ...
        <p>URL Request</p>
<pre class="bg-dark rounded text-white"><code><?php echo e(url('/')); ?>/send-poll?sender=081222xxxxxx&amp;api_key=123456789&amp;number=201111xxxxxx&amp;name=what color do you like&amp;option=red,blue,yellow&amp;countable=1&amp;full=1</code></pre>
...
<?php /**PATH /www/wwwroot/public_html/website/wa.bdi.asia/resources/themes/vuexy/views/pages/api-docs/send-poll.blade.php ENDPATH**/ ?>