<div class="tab-pane fade show" id="buttonmessage" role="tabpanel">
	...
	<button type="button" id="add-button" class="btn btn-success btn-sm mt-4"><?php echo e(__('Add Button')); ?></button>
</div>
<script>
	let buttonIndex = 0;
	const maxButtons = 4;
	...
	document.getElementById('add-button').addEventListener('click', function () {
	    if (buttonIndex >= maxButtons) {
	        toastr.warning("<?php echo e(__('Maximal 4 button')); ?>");
	        return;
	    }
	
	    const label = "<?php echo e(__('Button :x')); ?>".replace(':x', buttonIndex + 1);
...
</script><?php /**PATH /www/wwwroot/public_html/website/wa.bdi.asia/resources/themes/vuexy/views/ajax/blast/formbutton.blade.php ENDPATH**/ ?>