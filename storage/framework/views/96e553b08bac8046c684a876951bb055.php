<div class="tab-pane fade " id="createuser" role="tabpanel">
    ...
    <p>Endpoint: <code><?php echo e(url('/')); ?>/create-user</code></p>
...
<pre class="bg-dark rounded text-white"><code class="json"><?php echo e(url('/')); ?>/create-user?api_key=1234567890&username=magd&password=12345678&email=ttmttxx@xx.com&expire=30&limit_device=10</code></pre>
...
<?php /**PATH /www/wwwroot/public_html/website/wa.bdi.asia/resources/themes/vuexy/views/pages/api-docs/createuser.blade.php ENDPATH**/ ?>