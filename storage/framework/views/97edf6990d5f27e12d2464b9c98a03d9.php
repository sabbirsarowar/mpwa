<div class="tab-pane fade " id="checknumber" role="tabpanel">
    ...
    <p>Endpoint: <code><?php echo e(url('/')); ?>/check-number</code></p>
...
<pre class="bg-dark rounded text-white"><code class="json"><?php echo e(url('/')); ?>/check-number?api_key=1234567890&sender=6281222xxxxx&number=201111xxxxx</code></pre>
...
<?php /**PATH /www/wwwroot/public_html/website/wa.bdi.asia/resources/themes/vuexy/views/pages/api-docs/check-number.blade.php ENDPATH**/ ?>