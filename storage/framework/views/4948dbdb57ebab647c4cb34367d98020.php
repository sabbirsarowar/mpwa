...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'theme::components.layout-dashboard','data' => ['title' => ''.e(__('Create Campaign')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Create Campaign')).'']); ?>
	<style>
	...
	<link rel="stylesheet" href="<?php echo e(asset('vendor/libs/bs-stepper/bs-stepper.css')); ?>?v=<?php echo e(config('app.version')); ?>" />
	<link rel="stylesheet" href="<?php echo e(asset('vendor/libs/bootstrap-select/bootstrap-select.css')); ?>?v=<?php echo e(config('app.version')); ?>" />
	...
	<link rel="stylesheet" href="<?php echo e(asset('vendor/libs/nouislider/nouislider.css')); ?>?v=<?php echo e(config('app.version')); ?>" />
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb breadcrumb-custom-icon">
			<li class="breadcrumb-item">
				<a href="javascript:void(0);"><?php echo e(__('Campaign')); ?></a>
...
<?php endif; ?>
			...
			<div class="bs-stepper vertical wizard-modern wizard-modern-vertical mt-2">
				<div class="bs-stepper-header">
					<div class="step" data-target="#step-1">
						...
						<span class="bs-stepper-title"><?php echo e(__('Step 1')); ?></span>
						<span class="bs-stepper-subtitle"><?php echo e(__('Create name')); ?></span>
						</span>
						</button>
					</div>
					<div class="line"></div>
					<div class="step" data-target="#step-2">
						...
						<span class="bs-stepper-label">
						<span class="bs-stepper-title"><?php echo e(__('Step 2')); ?></span>
						<span class="bs-stepper-subtitle"><?php echo e(__('Set message and destination')); ?></span>
						</span>
						</button>
					</div>
					<div class="line"></div>
					<div class="step" data-target="#step-3">
						...
						<span class="bs-stepper-label">
						<span class="bs-stepper-title"><?php echo e(__('Step 3')); ?></span>
						<span class="bs-stepper-subtitle"><?php echo e(__('Delay and Campaign type')); ?></span>
						</span>
						</button>
					</div>
				</div>
					...
					<form>
						<div id="step-1" class="content">
							<div class="form-group">
								<label class="form-label" for="campaignName"><?php echo e(__('Sender Number / Device')); ?></label>
								<input type="text" class="form-control" id="campaignName" name="sender" placeholder="<?php echo e(__('Enter campaign name')); ?>" value="<?php echo e(session('selectedDevice')['device_body']); ?>" disabled>
								<input type="hidden" name="device_id" id="device_id" value="<?php echo e(session('selectedDevice')['device_id']); ?>">
							</div>
							<div class="form-group mt-4">
								<label class="form-label" for="campaign_name"><?php echo e(__('Campaign Name')); ?></label>
								<input type="text" class="form-control" id="campaign_name" name="campaign_name" placeholder="<?php echo e(__('Enter campaign name')); ?>" required>
							</div>
							<div class="d-flex justify-content-between mt-4">
								...
								<span class="d-sm-inline-block d-none"><?php echo e(__('Previous')); ?></span>
								</button>
								<button class="btn btn-sm btn-outline-primary btn-next">
								<span class="d-sm-inline-block d-none me-sm-2"><?php echo e(__('Next')); ?></span>
						...
						<div id="step-2" class="content">
							<div class="mb-3 form-group">
								<label class="form-label mb-2"><?php echo e(__('Select PhoneBook')); ?></label>
								<select id="phonebook_id" name="phonebook_id" class="form-select phonebook-option">
									...
									<option value="<?php echo e($phonebook->id); ?>">
										<?php echo e($phonebook->name); ?> (<?php echo e($phonebook->contacts_count); ?> <?php echo e(__('Numbers')); ?>)
									</option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
							</div>
							<div class="form-group">
								<label class="form-label"><?php echo e(__('Message Source')); ?></label>
								<div class="row">
									<div class="col-md-6">
										<div class="form-check">
											...
											<label class="form-check-label" for="message_source_new">
												<?php echo e(__('Create New Message')); ?>
							...
							<div class="form-group d-none" id="template-selection">
								...
								<select id="template_id" class="selectpicker w-100"
										  ...
										  title="<?php echo e(__('Choose a template...')); ?>">
								 </select>
								
								<div class="mt-2 d-flex justify-content-between align-items-center">
									<small class="text-muted" id="template-count"></small>
									
									<a href="<?php echo e(route('templates.create')); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
							...
							<div class="form-group" id="message-type-selection">
								<label for="type" class="form-label"><?php echo e(__('Type Message')); ?></label>
						...
						<div id="step-3" class="content">
							<div class="form-group mt-2">
								<label class="form-label"><?php echo e(__('Delay Per Message (Second)')); ?></label>
							...
							<div class="form-group">
								<label for="tipe" class="form-label"><?php echo e(__('Type')); ?></label>
								<select name="tipe" id="tipe" class="form-control">
									<option value="immediately"><?php echo e(__('Immediately')); ?></option>
									<option value="schedule"><?php echo e(__('Schedule')); ?></option>
								</select>
							</div>
							<div class="form-group d-none" id="datetime">
								<label for="datetime2" class="form-label"><?php echo e(__('Date Time')); ?></label>
								<input type="datetime-local" id="datetime2" name="datetime" class="form-control" value="<?php echo e(old('datetime', \Carbon\Carbon::now()->setTimezone(auth()->user()->timezone ?? config('app.timezone'))->format('Y-m-d\\TH:i'))); ?>">
							</div>
							<div class="d-flex justify-content-between mt-4">
								<button class="btn btn-sm btn-label-secondary btn-prev">
								<i class="ti tabler-arrow-left icon-xs me-sm-2 me-0"></i>
								...
								<button type="button" class="btn btn-sm btn-outline-success btn-submit"><?php echo e(__('Create Campaign')); ?></button>
							</div>
						</div>
					</form>
				</div>
	...
	<script src="<?php echo e(asset('vendor/libs/bs-stepper/bs-stepper.js')); ?>?v=<?php echo e(config('app.version')); ?>"></script>
	<script src="<?php echo e(asset('vendor/libs/bootstrap-select/bootstrap-select.js')); ?>?v=<?php echo e(config('app.version')); ?>" defer></script>
	...
	<script src="<?php echo e(asset('vendor/libs/nouislider/nouislider.js')); ?>?v=<?php echo e(config('app.version')); ?>"></script>
	<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			function loadTemplates() {
				$.ajax({
					url: '<?php echo e(route("templates.for-campaign")); ?>',
					method: 'POST',
					headers: {
					...
					success: function(response) {
						if (!response.error) {
							...
							if (countEl) {
								countEl.textContent = '<?php echo e(__("Templates")); ?>: ' + count;
							}
							...
							const groupedTemplates = response.templates.reduce((acc, template) => {
								const category = template.category || '<?php echo e(__("Uncategorized")); ?>';
								if (!acc[category]) {
									acc[category] = [];
								}
			...
			function loadTemplateData(templateId) {
				$.ajax({
					url: "<?php echo e(route('templates.show', ['id' => '___ID___'])); ?>".replace('___ID___', templateId),
					method: 'POST',
					headers: {
						'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
					},
					...
					error: function() {
						notyf.error('<?php echo e(__("Failed to load template data")); ?>');
					}
				});
			}
			...
			function populateFormWithTemplate(t) {
				...
				if (t.type === 'text') {
					...
					if (pv) {
						...
						if (priceEl) priceEl.innerHTML = '<?php echo e(__("Price:")); ?> ' + (op ? '<del class="text-muted me-2">'+op+'</del>' : '') + '<strong>' + (pr ? pr + ' ' + cur : '') + '</strong>';
			...
			function rebuildButtons(btns) {
				...
				for (let i=0;i<n;i++) {
					const label = '<?php echo e(__("Button :x")); ?>'.replace(':x', i+1);
					...
					if (extraWrap) {
						if (typeSel.value === 'url') {
							...
							extraWrap.innerHTML =
								'<div class="form-group mt-2">'+
									'<label class="form-label"><?php echo e(__("Copy Text")); ?></label>'+
				...
				for (let i=0;i<n;i++) {
					...
					const card =
						'<div class="card mb-3 section" id="section'+i+'" style="height:auto;">'+
							'<div class="card-header d-flex justify-content-between align-items-center">'+
								'<strong><?php echo e(__("Section")); ?> '+(i+1)+'</strong>'+
							...
							'<div class="card-body">'+
								'<div class="form-group">'+
									'<label class="form-label"><?php echo e(__("Title List")); ?></label>'+
								...
								'<button type="button" class="btn btn-outline-primary btn-sm mt-2 add-row" data-section="'+i+'"><?php echo e(__("Add Row")); ?></button>'+
							'</div>'+
						'</div>';
						...
						const row =
							'<div class="row-input mb-3" id="row'+i+'-'+j+'">'+
								'<div class="d-flex align-items-center">'+
									'<input type="text" name="sections['+i+'][rows]['+j+'][title]" class="form-control me-2" placeholder="<?php echo e(__("Row Title")); ?>" required>'+
									'<input type="text" name="sections['+i+'][rows]['+j+'][description]" class="form-control me-2" placeholder="<?php echo e(__("Row Description")); ?>">'+
			...
			noUiSlider.create(sliderTap, {
				start: [10, 50],
				behaviour: 'tap',
				direction: "<?php echo e(in_array(app()->getLocale(), ['ar', 'he', 'fa', 'ur']) ? 'rtl' : 'ltr'); ?>",
				connect: true,
				range: { min: 1, max: 180 },
				tooltips: [true, true],
				format: {
			...
			function checkMultipleForm(type) {
				...
				if (type === 'button') {
					...
					if (buttonTypes.length === 0) {
						notyf.error(`<?php echo e(__("Please add at least one button")); ?>`);
						return false;
					}
					for (const select of buttonTypes) {
						...
						if (!select.value || !display || !display.value.trim()) {
							notyf.error(`<?php echo e(__("All button fields must be filled")); ?>`);
							return false;
						}
						if (select.value === 'call') {
							const phone = pane.querySelector(`[name="button[${id}][phoneNumber]"]`);
							if (!phone || !phone.value.trim()) {
								notyf.error(`<?php echo e(__("Phone number is required for Call button")); ?>`);
								return false;
							}
						} else if (select.value === 'url') {
							const url = pane.querySelector(`[name="button[${id}][url]"]`);
							if (!url || !url.value.trim()) {
								notyf.error(`<?php echo e(__("URL is required for URL button")); ?>`);
								return false;
							}
						} else if (select.value === 'copy') {
							const code = pane.querySelector(`[name="button[${id}][copyCode]"]`);
							if (!code || !code.value.trim()) {
								notyf.error(`<?php echo e(__("Copy text is required for Copy button")); ?>`);
								return false;
							}
						}
					}
				...
				if (type === 'sections') {
					...
					if (sections.length === 0) {
						notyf.error(`<?php echo e(__("Please add at least one section")); ?>`);
						return false;
					}
					...
					for (const section of sections) {
						...
						if (!titleInput || !titleInput.value.trim()) {
							notyf.error(`<?php echo e(__("Section title cannot be empty")); ?>`);
							return false;
						}
						const rows = section.querySelectorAll('.row-input');
						if (rows.length === 0) {
							notyf.error(`<?php echo e(__("Please add at least one row to each section")); ?>`);
							return false;
						}
						for (const row of rows) {
							const rowTitle = row.querySelector('input[name*="[rows]"][name$="[title]"]');
							if (!rowTitle || !rowTitle.value.trim()) {
								notyf.error(`<?php echo e(__("Each row must have a title")); ?>`);
								return false;
							}
						}
					}
			...
			const fv1 = FormValidation.formValidation(document.querySelector('#step-1'), {
				fields: {
					campaign_name: {
						validators: {
							notEmpty: {
								message: '<?php echo e(__("Campaign Name is required")); ?>'
							}
						}
					}
				},
			...
			const fv2 = FormValidation.formValidation(document.querySelector('#step-2'), {
				fields: {
					phonebook_id: {
						validators: {
							notEmpty: {
								message: '<?php echo e(__("Please select PhoneBook")); ?>'
							}
						}
					},
					type: {
						validators: {
							notEmpty: {
								message: '<?php echo e(__("Please select Message Type")); ?>'
							}
						}
					}
				},
			...
			const fv3 = FormValidation.formValidation(document.querySelector('#step-3'), {
				fields: {
					delay: {
						validators: {
							notEmpty: {
								message: '<?php echo e(__("Delay is required")); ?>'
							},
							between: {
								min: 1,
								max: 180,
								message: '<?php echo e(__("Delay must be between 1 and 60")); ?>'
							}
						}
					},
					tipe: {
						validators: {
							notEmpty: {
								message: '<?php echo e(__("Please select Campaign Type")); ?>'
							}
						}
					},
					datetime: {
						validators: {
							callback: {
								message: '<?php echo e(__("Please select valid datetime")); ?>',
				...
				btn.addEventListener('click', e => {
					...
					if (i === 0) {
						...
						fv2.validate().then(r => {
							...
							if (ok) stepper.next();
							else notyf.error('<?php echo e(__("Please fill all required fields.")); ?>');
						});
					}
				});
			});
			...
			document.querySelector('.btn-submit').addEventListener('click', function (e) {
				...
				fv3.validate().then(function (result) {
					...
					$.ajax({
						url: '<?php echo e(route("campaign.store")); ?>',
						method: 'POST',
						data: formData,
						processData: false,
						contentType: false,
						...
						error(err) {
							console.error(err);
							notyf.error('<?php echo e(__("An error occurred while submitting the form.")); ?>');
						}
					});
				});
			});
...
<?php endif; ?><?php /**PATH /www/wwwroot/public_html/website/wa.bdi.asia/resources/themes/vuexy/views/pages/campaign/create.blade.php ENDPATH**/ ?>