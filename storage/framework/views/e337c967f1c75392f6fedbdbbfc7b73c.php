                ...
                <div class="chat">
                    <div class="chat-container">
                        <div class="user-bar">
                            ...
                            <div class="avatar">
                                <img src="<?php echo e(asset('img/avatars/1.png')); ?>" alt="Avatar">
                            </div>
                            <div class="name">
                                <span><?php echo e(__('MPWA')); ?></span>
                                <span class="status"><?php echo e(__('online')); ?></span>
                            </div>
                        ...
                        <div class="conversation">
                            ...
                            <form class="conversation-compose">
                                ...
                                <input class="input-msg" name="input" placeholder="<?php echo e(__('Type a message')); ?>" autocomplete="off" autofocus disabled>
                                <div class="photo">
...
<?php /**PATH /www/wwwroot/public_html/website/wa.bdi.asia/resources/themes/vuexy/views/ajax/messages/textshow.blade.php ENDPATH**/ ?>